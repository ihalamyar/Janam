...
<section id="page-banner" class="pt-105 pb-110 bg_cover" data-overlay="8" style="background-image: url(../public/images/page-banner-1.jpg)">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="about-image mt-50">
                    <img src="../public/images/about/about-2.jpg" alt="About">
                </div>
                <!-- about imag -->
            </div>
        </div>
