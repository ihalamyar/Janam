 ...
 <footer id="footer-part">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-about mt-40">
                            <div class="logo">
                                <a href="#"><img src="../public/images/logo-2.png" alt="Logo"></a>
                            </div>
    ...
    <!--====== Magnific Popup js ======-->
    <script src="../public/resources/js/jquery.magnific-popup.min.js"></script>
    ...
    <!--====== Nice Number js ======-->
    <script src="../public/resources/js/jquery.nice-number.min.js"></script>
    
    <!--====== Count Down js ======-->
    <script src="../public/resources/js/jquery.countdown.min.js"></script>
    
    <!--====== Validator js ======-->
    <script src="../public/resources/js/validator.min.js"></script>
    
    <!--====== Ajax Contact js ======-->
    <script src="../public/resources/js/ajax-contact.js"></script>
