    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-2 bg_cover" style="background-image: url(../public/images/slider/s-2.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url(../public/images/slider/s-3.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url(../public/images/slider/s-1.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
                    ...
                    <div class="category-2-items pt-10">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="../public/images/category/ctg-1.jpg" alt="Category">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="../public/images/category/ctg-2.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="../public/images/category/ctg-3.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>UI/ UX Design</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="../public/images/category/ctg-4.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Photography</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="../public/images/category/ctg-5.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Finance</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="../public/images/category/ctg-6.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Science</h5>
            ...
            <div class="row course-slied mt-30">
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="../public/images/course/cu-4.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="../public/images/course/cu-5.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                    ...
                    <div class="happy-student mt-55">
                        ...
                        <div class="student-slied">
                            <div class="singel-student">
                                <img src="../public/images/teachers/teacher-2/quote.png" alt="Quote">
                        ...
                        <div class="student-image">
                            <img src="../public/images/teachers/teacher-2/happy.png" alt="Image">
                        </div>
                    </div>
                    <!-- happy student -->
                </div>
    ...
    <section id="event-part" class="pt-120">
        <div class="container">
            <div class="event-bg bg_cover" style="background-image: url(../public/images/bg-3.jpg)">
                <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="singel-news mt-30">
                        <div class="news-thum pb-25">
                            <img src="../public/images/news/n-1.jpg" alt="News">
                        </div>
                        <div class="news-cont">
                            <ul>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="../public/images/news/ns-1.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="../public/images/news/ns-2.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="../public/images/news/ns-3.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
            ...
            <div class="row patnar-slied">
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="../public/images/patnar-logo/p-1.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="../public/images/patnar-logo/p-2.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="../public/images/patnar-logo/p-3.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="../public/images/patnar-logo/p-4.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
