<?php require_once __DIR__ . '../public/ini/header.php'; ?>
    ...
    <section id="slider-part-3" class="bg_cover" style="background-image: url(../public/images/slider/s-3.jpg)">
        <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="singel-slider-feature justify-content-center mt-30">
                            <div class="icon">
                                <img src="../public/images/all-icon/man.png" alt="icon">
                            </div>
                            <div class="cont">
                                <h3>13,0000</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="singel-slider-feature justify-content-center mt-30">
                            <div class="icon">
                                <img src="../public/images/all-icon/book.png" alt="icon">
                            </div>
                            <div class="cont">
                                <h3>4,000509</h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="singel-slider-feature justify-content-center mt-30">
                            <div class="icon">
                                <img src="../public/images/all-icon/expert.png" alt="icon">
                            </div>
                            <div class="cont">
    ...
    <section id="count-down-part" class="bg_cover pt-70 pb-120" data-overlay="8" style="background-image: url(../public/images/bg-2.jpg)">
        <div class="container">
