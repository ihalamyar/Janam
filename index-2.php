                        ...
                        <div class="col-lg-4">
                            <a href="#">
                                <span class="singel-category text-center color-1">
                                    <span class="icon">
                                        <img src="../public/images/all-icon/ctg-1.png" alt="Icon">
                                    </span>
                                    <span class="cont">
                                        <span>Language</span>
                                    </span>
                        ...
                        <div class="col-lg-4">
                            <a href="#">
                                <span class="singel-category text-center color-2">
                                    <span class="icon">
                                        <img src="../public/images/all-icon/ctg-2.png" alt="Icon">
                                    </span>
                                    <span class="cont">
                                        <span>Business</span>
                                    </span>
                        ...
                        <div class="col-lg-4">
                            <a href="#">
                                <span class="singel-category text-center color-3">
                                    <span class="icon">
                                        <img src="../public/images/all-icon/ctg-3.png" alt="Icon">
                                    </span>
                                    <span class="cont">
...
<section id="about-part" class="pt-65">
    ...
    <!-- container -->
    <div class="about-bg">
        <img src="../public/images/about/bg-1.png" alt="About">
    </div>
</section>
                    ...
                    <ul>
                        <li>
                            <div class="singel-feature">
                                <div class="icon">
                                    <img src="../public/images/all-icon/f-1.png" alt="icon">
                                </div>
                                <div class="cont">
                        ...
                        <li>
                            <div class="singel-feature">
                                <div class="icon">
                                    <img src="../public/images/all-icon/f-2.png" alt="icon">
                                </div>
                                <div class="cont">
                        ...
                        <li>
                            <div class="singel-feature">
                                <div class="icon">
                                    <img src="../public/images/all-icon/f-3.png" alt="icon">
                                </div>
                                <div class="cont">
                                    <h4>Books & Library</h4>
                                    <p>Gravida nibh vel velit auctor aliquetn auci elit cons solliazcitudirem sem quibibendum sem nibhutis.</p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="singel-publication mt-30">
                    <div class="image">
                        <img src="../public/images/publication/p-1.jpg" alt="Publication">
                        <div class="add-cart">
                            <ul>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="singel-publication mt-30">
                    <div class="image">
                        <img src="../public/images/publication/p-2.jpg" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="singel-publication mt-30">
                    <div class="image">
                        <img src="../public/images/publication/p-3.jpg" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-8">
                <div class="singel-publication mt-30">
                    <div class="image">
                        <img src="../public/images/publication/p-4.jpg" alt="Publication">
                        <div class="add-cart">
                            <ul>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
    ...
    <div class="container">
        ...
        <div class="row testimonial-slied mt-40">
            <div class="col-lg-6">
                <div class="singel-testimonial">
                    <div class="testimonial-thum">
                        <img src="../public/images/testimonial/t-1.jpg" alt="Testimonial">
                        <div class="quote">
            ...
            <div class="col-lg-6">
                <div class="singel-testimonial">
                    <div class="testimonial-thum">
                        <img src="../public/images/testimonial/t-2.jpg" alt="Testimonial">
                        <div class="quote">
                            <i class="fa fa-quote-right"></i>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="singel-testimonial">
                    <div class="testimonial-thum">
                        <img src="../public/images/testimonial/t-3.jpg" alt="Testimonial">
                        <div class="quote">
                            <i class="fa fa-quote-right"></i>
                        </div>
                    </div>
